...
- Final system design and tech selection : 15/2
- Final UX design 08/03 

## Final Major Project Lecture: 

- Project can be re-directed to from /workspace/COM559/
- When evaluating project overall look over BCS guidelines for it's writing direction 

(No more FET classes)

Be prepared for a 'dry run' in Week 11 with mentor 


Oral: 

`I set out to,`
`I used ____ to achieve this,` 
`I am proud of how ____ turned out,` 
`I would change ____ if I had more time`


- When talking of implementation in the report list the biggest technical achievements of the project 


## Mentor Feedback Session: 

- Think of the use cases for components, show how broad they can be, e.g multiple dice for different gaming scenarios 

- When removing chosen components if a user had it previously selected it's data should be removed also, UI prompting if the user is sure they want to carry out that action 

- Save option sounds like the most appropriate option as opposed to making constant DB calls whenever a component is updated 

- Look at all possible UI pitfalls or area's where the user shouldn't be able to access pieces of UI without authentication
