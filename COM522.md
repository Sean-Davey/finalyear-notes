...
- Green ( Topics can cause problems if not progressed appropriately, has potential)

- Amber ( Can be easily refocused, reconsider scope, narrower, wider)

- Red (Avoid, outside of disipline etc)


- ( No history lessons, can state origin but not a whole introduction )

- Dont get hung up on hardware, focus on software, processing / processes, algorithms, SDK's 

- One to one meetings - how to broaden topic 

- Work on a report plan 


# Chosen topic : BCI For Games 

* How to broaden the topic 

* Research that is developing for BCI but doesn't mention Games specifically, can it be tied in? 

* Prevent fallback on talking about the hardware rather than software 

* Plently on controversary, Microsoft gamifying war 

* BrainCo developing an SDK, potential to pair that with Hololens 2 

* [Valve Gaming Company presenting research on BCI next week at GDC](https://www.roadtovr.com/valve-psychologist-to-explore-brain-computer-interface-research-at-gdc-2019-mike-ambinder/)



 # Searching Literature 
 
 - try and find the papers behind videos, if able 
 - Make a plan 

 
 # Feedback Session 
 
 - Watch out for references, when using youtube videos or presentations cite the proper author
 
 - Talk more about software over hardware, the hardware is always the same 

 - If there's no exact relationship between BCI and gaming directly, make the links between them and elaborate on how BCI techniques and / or software could be used with gaming 

 - 'The role BCI has or could have in gaming' could be a better way to describe the role or relationship between both 
 ...
 Short : Personal Multimedia Device 
 
 Reference: Bush Vannevar, (1945) 'As we may think', The Atlantic Monthly, 
 
 
 Full Report Example review: 
 
 - Include reference in opening paragraph explanation, 
 
 
 ## Week 9 
 
 - Writing style guide, formal language, third person, avoid conjunctions like: don't, i'll, shouldn't, 
